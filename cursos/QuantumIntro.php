...
<div class="inner">
			<div class="content">
				...
				<h3>Contenidos:</h3><li>Introducción a los cursos</li><li>Conocimientos previos</li><li>Curso básico: Introducción y puertas lógicas cuánticas</li><li>Curso avanzado: Tele-transportación cuántica de datos</li>
			</div>
</section>
</div>
</header>
