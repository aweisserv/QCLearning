...
<br><br><br><br>
<section id="main">
	<a href="#" class="button primary">Introducción</a>
	<a href="#" class="button primary">Contenidos</a>
	<a href="#" class="button primary">Parte 2</a>
	<a href="#" class="button primary">Ver cursos</a>
