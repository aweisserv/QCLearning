...
<section id="main">
	...
	<a href="QuantumTeleportBASICbeta2.html" class="button primary">Part II</a>
	<a href="QuantumTeleportADV.php" class="button primary">Courses</a>
		...
		<section id="main">
			<div class="inner">
				...
				<div class="content" style="text-align: left;">
					...
					<br/><a href="QuantumTeleportBASICbeta2.html">Basic course: Part II</a><br><br><a href="#">Go top of the page</a></p>
				</div>
			</div>
		</section>
	</div> 
