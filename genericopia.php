		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="content">
						<header>
							<h2>Prototipo de evaluación de diagnóstico<br /> </h2><h3> En esta sección, podrá realizar un test de diagnóstico que evaluará sus conocimientos en Informática cuántica. Al finalizar el test, Obtendrá un puntaje de acuerdo a la cantidad de preguntas respondidas correctamente. El puntaje obtenido lo ayudará a escoger una sección de aprendizaje adecuada según sus conocimientos en el área.</h3>
					<!-- Ancla -->	
					...
					<!-- Test Javascript -->	
						...
						<script>
							...
							var questions = [
								...
								[ "Pregunta 3?", "correcta", "incorrecta", "incorrecta", "A" ],
								[ "Pregunta 4?", "incorrecta", "incorrecta", "correcta", "C" ]
							];
