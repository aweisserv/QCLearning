...
<!-- Revisión de puntaje mínimo para acceso -->
	...
	if ($_SESSION['puntaje']<400) {
		echo '<script>alert("No posees el puntaje requerido para rendir esta prueba.")</script> ';
...
<html>
	...
	<body class="is-preload">
		...
		<!-- Heading -->
			<div id="heading" >
				<h1>Prueba de contenidos </h1><h2> Parte I</h2>
			</div>
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
					<div class="content">
						<header>
							<h2>Prototipo de evaluación de conocimientos adquiridos en el curso básico<br /> </h2>En esta sección, podrá realizar un test que evaluará los conocimientos aprendidos en lo que lleva del curso. Al finalizar el test, Obtendrá un puntaje de acuerdo a la cantidad de preguntas respondidas correctamente. El puntaje obtenido podría permitirle acceder a la segunda parte del curso.

<!--Anlca a contenidos -->
<a name="Anchor"></a>

					<!-- Ancla -->	
							<div id="startprueba"></div>
							<hr/> 
						<!--
					...
					<!-- Test Javascript -->	
						...
						<script>
							...
							var questions = [
							    [ "Teniendo nuestro circuito cuántico realizado anteriormente:<br> <img src='images/12.png' width='400' height='182'><br>¿Cuál es el resultado que debiese esperar después de la medición?" , "00", "11", "Dependerá del resultado de la medición", "C" ],
							...
							function renderQuestion(){
								...
								if(pos >= questions.length && correct <= questions.length/3){
									test.innerHTML = "<h2> Has obtenido "+correct+" de "+questions.length+" preguntas correctas</h2><br>	 <h3>Te sugerimos volver empezar <a href='section/QuantumTeleportBASICbeta.php'>Click aquí</a>";
									...
									test.innerHTML = "<h3> Has obtenido "+correct+" de "+questions.length+" preguntas correctas</h3><br><hr/>" + "<a href=../cursos/QuantumTeleportBASICbeta2.php class='button primary'>Continuar</a>";
									

									_("test_status").innerHTML = "Prueba finalizada";
