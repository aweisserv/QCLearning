...
<html>
	...
	<body class="is-preload">
		...
		<!-- Heading -->
			<div id="heading" >
				<h1>Prueba de contenidos </h1><h2> Quantum Kit</h2>
			</div>
						...
						<script>
							...
							function renderQuestion(){
								...
								if(pos >= questions.length && correct <= questions.length/3){
									...
									test.innerHTML = "<h3> Has obtenido "+correct+" de "+questions.length+" preguntas correctas</h3><br><hr/>" + "<a href='obt_puntaje3.php' class='button primary'>Continuar</a>";
