						...
						<script>
							...
							function renderQuestion(){
								...
								if(pos >= questions.length && correct <= questions.length/3){
									...
									test.innerHTML = "<h3> Has obtenido "+correct+" de "+questions.length+" preguntas correctas</h3><br><hr/>" + "<a href=../cursos/QuantumTeleportADV3F.php class='button primary'>Continuar</a>";
