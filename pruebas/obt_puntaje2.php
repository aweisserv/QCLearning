  ...
  <div class="inner">
    <div class="content">
      <div class="inner">
        ...
        <h1>Curso avanzado completado</h1><hr>
          <div class="row">
          <div class="highlight">
        <form method="POST" action="obt_puntaje2.php" >

        <div class="form-group">
          <label for="puntaje">Puntaje obtenido:</label>
          <input type="text" name="puntaje" class="form-control" id="puntaje" value="800" readonly="readonly">
        </div>
